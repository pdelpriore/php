...
class DetailController extends Controller
{
    ...
    {
        return $this->render('detail/index.html.twig', ['details' => $detailRepository->findAll()]);
    }
    ...
    {
        return $this->render('detail/show.html.twig', ['detail' => $detail]);
    }
    ...
    public function edit(Request $request, Detail $detail): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('detail_edit', ['id' => $detail->getId()]);
        }
